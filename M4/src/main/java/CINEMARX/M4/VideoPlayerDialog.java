...
public class VideoPlayerDialog {
    ...
    public static void openVideo(JFrame parent, String videoUrl) {
        try {
            ...
            if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
                ...
                CustomDialog dialog = new CustomDialog(M4.getMainFrame(), "Trailer abierto en tu navegador.");
    ...
    private static void mostrarURLManual(JFrame parent, String videoUrl) {
